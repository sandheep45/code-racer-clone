...
import { ArrowRightIcon, TargetIcon } from "@radix-ui/react-icons";
    ...
    >
      <CardHeader>
        <div className="grid text-center place-content-center">
          <TargetIcon className="justify-self-center h-10 w-10" />
          <h2
      ...
      <CardContent>
        ...
        >
          ...
          >
            Practice{" "}
            <ArrowRightIcon className="absolute -translate-y-1/2 right-4 top-1/2" />
          </Button>
        </form>
      </CardContent>
    </Card>
