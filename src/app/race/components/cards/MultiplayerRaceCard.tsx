...
import Battle from "@/components/assets/svg/Battle";
    ...
    <Card className="flex flex-col justify-between flex-1 border-2 border-warning">
      <CardHeader>
        <div className="grid text-center place-content-center">
          <Battle className="justify-self-center h-10 w-10" />
          <h2
          ...
          {!enabled ? (
            ...
            <>
              ...
              >
                Start racing
                {isLoading ? (
                  <Loader className="text-white absolute -translate-y-1/2 opacity-50 right-4 top-1/2" />
                ) : (
                  <ArrowRightIcon className="absolute -translate-y-1/2 opacity-50 right-4 top-1/2" />
                )}
              </Button>
            </>
          )}
